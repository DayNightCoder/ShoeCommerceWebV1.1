    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				<h4><span><spring:message code="lang.productDetails" ></spring:message></span></h4>
			</section>
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="<c:out value='${product1.img}'></c:out>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="<c:out value='${product1.img}'></c:out>"></a>												
								
							</div>
							<div class="span5">
								<address>
									<strong><c:out value='${product1.name}'></c:out></strong> <span></span><br>
									<strong>Product Code:</strong> <span><c:out value='${product1.id}'></c:out></span><br>
									
									<strong><spring:message code="lang.availability" ></spring:message></strong> <span>
									<spring:message code="lang.available" ></spring:message>
								
									</span><br>								
								</address>									
								<h4><strong><c:out value='${product1.price}'></c:out></strong></h4>
							</div>
							<div class="span5">
                                          <form:form modelAttribute="cart"  action="addToCart" method='get'>
								...
								<form:hidden path="user.user_id" />
										...
										<div class="span1"><label>Qty:</label><form:select items="${qtyMap}" path="cart_quantity" cssClass="input-mini" />
										<br>
										
										<label>Size:</label><form:select items="${qtyMap}" path="cart_size" cssClass="input-mini" />
										<br>
										
									<button class="btn btn-inverse" type="submit" name="submit">Add to Cart</button></div>
								</form:form>
							</div>							
						</div>
						<div class="row">
							<div class="span9">
								<ul class="nav nav-tabs" id="myTab">
									<li class="active"><a href="#home"><spring:message code="lang.description" ></spring:message></a></li>
