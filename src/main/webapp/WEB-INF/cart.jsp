    ...
    alert("Item Deleted");        
				...
				<div class="row">
					<div class="span9">					
						...
						<c:set value="${item.product.price*item.cart_quantity+total}" var="total"></c:set>
								<tr>
									<td><form action="deleteCart" method="get">
									 <br>
									 <input type="hidden" name="id" value="<c:out value='${item.cart_id}'></c:out>">
									 			<input class="btn" type="submit" value="Delete"/></form>
									
									<td><a href="product_detail.html"><img alt="" width="150" height="100" src="<c:out value='${item.product.img}'></c:out>"></a></td>
									<td><c:out value="${item.product.name}"></c:out></td>
									<td>
									<form action="updateCart" method="get">
									<input type="hidden" value="<c:out value='${item.cart_id}' ></c:out>" name="id">
									
									<input type="text" placeholder="<c:out value='${item.cart_quantity}' ></c:out>" name="qty" class="input-mini">
									<br>
									<input class="btn" type="submit" value="Update"/></form>
									</td>
									
									<td><c:out value="${item.product.price}"></c:out></td>
									<td><c:out value="${item.product.price*item.cart_quantity}"></c:out></td>
								</tr>	
						...
						<p class="cart-total right">
							...
							<strong>VAT (12.0%)</strong>: <c:out value="${total*12/100}"></c:out><br>
							<strong>Total</strong>:<c:out value="${total*12/100 + total}"></c:out><br>
						</p>
						<hr/>
