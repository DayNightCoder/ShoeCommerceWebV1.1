...
<html>
    ...
    pageEncoding="UTF-8"%>
		...
		<link href="https://dl.dropboxusercontent.com/s/2420jgw59fay4jj/style.css" rel='stylesheet' type='text/css' />
		...
		<script src="https://dl.dropbox.com/s/r9pgc26jo4wl2v7/menu_jquery.js"></script>
		<!-- //End menu -->
		<!---move-top-top---->
		<script type="text/javascript" src="https://dl.dropbox.com/s/700h61ifd60erwm/move-top.js"></script>
		...
		<!---//move-top-top---->
		<!-- Owl Carousel Assets -->
		<link href="https://dl.dropboxusercontent.com/s/3cwuovgz9eg6k3r/owl.carousel.css" rel="stylesheet">
		<script src="js/jquery-1.9.1.min.js"></script> 
		     <!-- Owl Carousel Assets -->
		    <!-- Prettify -->
		    <script src="https://dl.dropboxusercontent.com/s/wupbex88qgqgfju/owl.carousel.js"></script>
		        <script>
		    $(document).ready(function() {
		...
		<div class="content details-page">
			...
			<div class="product-details">
				...
				<!-- Include the Etalage files -->
					<link rel="stylesheet" href="https://dl.dropboxusercontent.com/s/rdmu1cfaqchpuny/etalage.css">
					<script src="https://dl.dropbox.com/s/ezct4nqimpavqs0/jquery.etalage.min.js"></script>
				<!-- Include the Etalage files -->
				<script>
						jQuery(document).ready(function($){
				...
				<div class="details-left">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="${product.img}" />
									<img class="etalage_source_image" src="${product.img}" />
								</a>
							</li>
					...
					<div class="details-left-info">
						...
						<div class="product-more-details">
							<ul class="price-avl">
								<li class="price"><label><c:out value="${product.price}"></c:out></label></li>
